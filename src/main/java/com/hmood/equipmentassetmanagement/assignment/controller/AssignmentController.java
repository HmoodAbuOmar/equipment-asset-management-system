...
public class AssignmentController {
    ...
    public ResponseEntity<AssignmentResponse> createAssignment(@Valid @RequestBody CreateAssignmentRequest request, Authentication authentication) {
        ...
        AssignmentResponse response = assignmentService.createAssignment(request,authentication);
    ...
    public ResponseEntity<AssignmentResponse> returnAssignment(@PathVariable Long id,Authentication authentication) {

        AssignmentResponse response = assignmentService.returnAssignment(id,authentication);
