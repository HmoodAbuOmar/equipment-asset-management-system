...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleSerialNumberAlreadyExists(
            SerialNumberAlreadyExistsException exception,
            HttpServletRequest request) {
    ...
    public ResponseEntity<ApiErrorResponse> handleMethodValidation(
        ...
        for (ParameterValidationResult validationResult
            ...
            String message = validationResult.getResolvableErrors()
                    .stream()
